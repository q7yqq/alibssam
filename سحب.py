    ...
    while True:
        try:
            ...
            cookies = {
                ...
                'bm_sv': '8B9270F6DC4EC8A6561E2DF933584D54~~1',
            ...
            params = {
                ...
                'os': 'linux',
                'priority_region': random.choice(['IN', 'BD']), # تم التعديل هنا للهند وبنغلاديش
                'referer': '',
                'region': random.choice(['IN', 'BD']), # تم التعديل هنا للهند وبنغلاديش
                'screen_height': '800',
                'screen_width': '360',
